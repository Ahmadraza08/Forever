...
//                 <button onClick={()=>setSize(item)} className={`border-gray-100 border py-2 px-4 bg-gray-100 ${item === size ? 'border-gray-500' : ''}`} key={index}>{item}</button> 
//               ))}
//             </div>
//           </div>
...
//             <p>Cash on delivery is available o this product.</p>
            ...
            <div className='flex gap-2'>
              {productData.sizes.map((item, index) => (
                <button 
                  ...
                  className={`border-gray-100 border py-2 px-4 bg-gray-100 ${item === size ? 'border-gray-500' : ''}`} 
                  key={index}
                >
                  {item}
                </button>
